    ...
    <!-- Chamada PHP Header -->
        <?php
            if ( isset($_SESSION["IDUSER"]) )  {
                ...
                $saudacao = "SELECT usuarioNome, usuarioId, qtdAcesso, u.escolaId, nomeEscola, nivelId ";
			...
			$nivelId  = $saudacao_login["nivelId"];
            }
        ?>
<head>
	<meta charset="UTF-8">
...
<body>
    ...
    <nav>
   		...
   		<li style="height:100px; ">
      		<a style="line-height:100px;">Cadastrar</a>
      			<ul class="w-200">
                    ...
                    <li><a href="cadAmigo.php">Amigo</a></li>
   		...
   		<li style="height:100px;">
            <a style="line-height:100px;">Pesquisar</a>
      			<ul class="w-200">
         			...
         			<li><a href="listaUnidade.php">Unidade</a></li>
        ...
        <li style="height:100px;">
            <a style="line-height:100px;">Relatório</a>
      			<ul class="w-200">
         			<li><a href="relatorioTotal.php">Todos os alunos</a></li>
                </ul>
   		</li>
		    <li style="height:100px;">
            <a style="line-height:100px;">Email</a>
      			<ul class="w-250">
         			<li><a href="envia.php">Meus alunos</a></li>
                    <li><a href="enviaTodos.php">Todos</a></li>
      			</ul>
   		</li>
